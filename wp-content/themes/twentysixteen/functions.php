...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Property', 'Property', 'twentythirteen' ),
        'singular_name'       => _x( 'Property', 'Property', 'twentythirteen' ),
...
function my_taxonomies_property() {
  ...
  register_taxonomy( 'property_cat', 'property', $args );
}
add_action( 'init', 'my_taxonomies_property', 0 );

/*
add_action( 'default_hidden_meta_boxes', 'propertycat_remove_meta_boxes', 10, 2 );
function propertycat_remove_meta_boxes( $hidden, $screen ) {
	if ( 'property' == $screen->id ) {
		$hidden = array(
			'property_catdiv',
    		);
	}
