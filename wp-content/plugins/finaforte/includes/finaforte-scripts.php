...
class Finaforte_Script {
    ...
    function finaforte_stylesheet() {
        ...
        // accounting js for currency exchange
        wp_register_script('finaforte-accounting-js', FINAFORTE_URL . 'assets/js/accounting.js');
        wp_enqueue_script('finaforte-accounting-js');
        ...
        wp_register_script('ftpp-public-script', FINAFORTE_URL . 'assets/js/ftpp-public.js', array('jquery'), FINAFORTE_VERSION, true);
    ...
    function finaforte_admin_stylesheet() {
        ...
        /*wp_register_script('finaforte-jquery', FINAFORTE_URL . 'assets/js/jquery-12.js');
        wp_enqueue_script('finaforte-jquery');*/
    }
}
