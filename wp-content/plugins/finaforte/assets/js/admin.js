jQuery(document).ready(function($) {
	 ...
	 jQuery('#btn_bg_color, #btn_text_color ,#theme_bg_color,#solvency_green_color,#solvency_yellow_color,#solvency_red_color,#liquidity_red_color,#liquidity_green_color,#liquidity_yellow_color').wpColorPicker();
...
function check()
{
   ...
   var goodColor = "#fff";
    ...
    if( pass1.value.length == 11 || pass1.value.length > 12 ){ 
